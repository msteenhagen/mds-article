...
\newcommand{\doilink}[1]{\texttt{\href{http://dx.doi.org/#1}{doi:#1}}}

\renewpagestyle{plain}{
  \setheadrule{0pt}
	\setfoot{}{\thepage}{}
	\ifdefined\publicationinfo
		\sethead{{\parbox[t][3cm]{.70\textwidth}{\footnotesize \strut \publicationinfo \\ \doilink{\doiinfo} }}} % http://dx.doi.org/\doiinfo
						{}
						{{\parbox[t][3cm]{.30\textwidth}{\footnotesize \strut \hfill \myemail}}}
	\else
		\sethead{\footnotesize \strut \emph{Draft only. Please do not cite without permission.}}
						{}
