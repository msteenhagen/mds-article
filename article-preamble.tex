...
% TODO turn into a document class
% TODO move defaults into separate definition file
% TODO test big, medium, small options for titlesec
% TODO find out why \emph{} needs to be protected in \title{}
%%
...
\documentclass[oneside,\myfontsize]{article}
\usepackage{fixltx2e}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[\mypapersize]{geometry}
\ifdefined\loadmainfont
  \loadmainfont
\fi
\ifdefined\loadmonofont
  \loadmonofont
\fi
\usepackage{booktabs}
\usepackage{graphicx}
...
\usepackage[\mylocalisation,cleanlook]{isodate}
...
\newcommand{\smallsectiontitles}{\def\setsmallsectiontitles{true}}
...
\pretitle{\par\vskip 5em \begin{flushleft}\Huge\bfseries}
