...
\renewpagestyle{plain}{
  \setheadrule{0pt}
	...
	\ifdefined\publicationinfo
		\sethead{{\parbox[t][3cm]{.66\textwidth}{\footnotesize \publicationinfo}}}
						{}
						{{\parbox[t][3cm]{.33\textwidth}{\footnotesize \hfill \myemail}}}
	\else
		\sethead{\footnotesize \emph{Draft only. Please do not cite without permission.}}
						{}
